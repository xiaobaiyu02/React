	...
	render(){
		return(
			<form name="reactFrom" onChange={ this.handleChange.bind(this) }>
				<section className="form-group">
					{
						INPUT_TYPES.map( (item,key) => {
							let name = 'input[' + item + ']';
							return <section key={ key } ><input className="form-control" type={ item } name={ name } placeholder={ name }/></section>
						})
					}
				</section>
				<section className="form-group">
					<label className="radio-inline"><input type="radio" name="input[radio]" value="girl" />girl</label>
					<label className="radio-inline"><input type="radio" name="input[radio]" value="boy" />boy</label>
				</section>
				<section className="form-group">
					<label className="checkbox-inline"><input type="checkbox" name="input[checkbox]" value="food" />food</label>
					<label className="checkbox-inline"><input type="checkbox" name="input[checkbox]" value="sleep" />sleep</label>
					<label className="checkbox-inline"><input type="checkbox" name="input[checkbox]" value="book" />book</label>
				</section>
				<section className="form-group">
					<select className="form-control" name="select[single]" defaultValue="song2">
				...
				<section className="form-group">
					<select className="form-control" name="select[multiple]" defaultValue={["papa","mama"]} multiple>
